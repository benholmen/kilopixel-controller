...
$102=200	(Z steps/mm. Calculate at 200 steps/rev * 16 microsteps / 16 mm per rev)

$110=4000	(X max speed mm/min: top tested speed 8000)
$111=6000	(Y max speed mm/min: top tested speed 6000)
$112=400	(Z max speed mm/min: top tested speed 800+; 400 is good)
...
$25=3000	(homing speed: initial seek speed)
$27=1.000	(homing pull-off, in mm: I want this to be enough to clear the limit switch, but < 1/4 turn of the Z-axis)
